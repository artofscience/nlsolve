...
from decision_criteria import EigenvalueChangeTermination, LoadTermination, EigenvalueTermination
...
controller = Adaptive(value=0.5, min=0.00001)
...
## continue controller step size from previous
...
stepper.controller_reset = True
out0 = stepper(terminated=EigenvalueTermination(-1.0, 0.01))
...
# note the time reset is still False!
out3 = stepper(out2.solutions[-1], controller_reset=False)
