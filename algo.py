...
def stepper(problem, point = None, default_positive_direction: bool = True, max_load: float = 1.0):
    ...
    return IncrementalSolver(solver, p=point, terminated=criteria, reset=False)